...
## Template C: Security/Trust & Safety (Cybersecurity, Gaming, Platforms) — $500 EARLY ADOPTER

**Subject:** Tamper-evident AI for [threat detection / moderation] — early pricing
...
## When to Use $500 vs $2,500

**Use $500 when:**
- You need cash THIS WEEK
- Talking to smaller teams (startup, mid-market)
- Target seems price-sensitive
- You're in "volume mode" (10+ emails/day)
- First 2 weeks of outreach (build momentum)

**Use $2,500 when:**
- Talking to F500 or large enterprise
- Buyer is VP-level or C-suite
- They mention "budget approved"
...
## Follow-Up for $500 Deals

**Day 3:**

> Hi [First Name],
> 
> Quick bump — $500 early adopter pricing is limited to first 20 customers. Still open to a 15-minute walkthrough this week?
> 
> — Herbert
...
**This week (Mon–Fri):**
- Send 50 emails/day using $500 templates
- Track aggressively (log every response)
- Book calls same-day or next-day
- Close on the call (send invoice immediately)
- Cash in 1–3 days (Zelle/ACH)

**Result:** $5k–$6k by Friday = survival achieved.

---

**Use these templates to close fast. Volume wins.**
