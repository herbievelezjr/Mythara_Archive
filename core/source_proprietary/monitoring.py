...
paradoxes_created_total = Counter(
    "mythara_paradoxes_created_total",
    "Total paradoxes created",
    ["system_type"]
)
...
blessings_total = Gauge(
    "mythara_blessings_total",
    "Total blessings in reservoir"
)

reservoir_score = Gauge(
    "mythara_reservoir_score",
    "Blessings Reservoir score (0-1)"
)

overflow_events_total = Counter(
    "mythara_overflow_events_total",
    "Total blessings overflow events"
)

# WebSocket metrics
websocket_connections = Gauge(
    "mythara_websocket_connections",
...
database_queries_total = Counter(
    "mythara_database_queries_total",
...
redis_operations_total = Counter(
    "mythara_redis_operations_total",
    "Total Redis operations",
    ["operation"]
)

redis_errors_total = Counter(
    "mythara_redis_errors_total",
    "Total Redis errors"
)

# Rate limiting metrics
rate_limit_hits_total = Counter(
    "mythara_rate_limit_hits_total",
...
class HealthChecker:
    ...
    async def check_all(self) -> Dict[str, Any]:
        ...
        if unhealthy:
            checks["status"] = "unhealthy" if "redis" in unhealthy or "database" in unhealthy else "degraded"
