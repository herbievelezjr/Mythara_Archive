...
- **Emotional Extortion Detection** — Quantifies manipulation patterns (guilt, shame, fear, gaslighting) to distinguish genuine consent from coerced compliance (see `EMOTIONAL_EXTORTION_API.md`)
